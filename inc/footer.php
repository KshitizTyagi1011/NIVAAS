<div class="container-fluid bg-dark text-white mt-5">
    <div class="row">
      <div class="col-lg-4 p-4">
        <h3 class="h-font fw-bold fs-3 mb-2">Nivaas</h3>
        <p>Lorem ipsum dolor sit, amet consectetur adipisicing elit.
          Iure aliquam eligendi nostrum ipsum numquam dolorum excepturi,
          corporis dignissimos ex obcaecati provident atque commodi
          quo autem sint voluptate amet explicabo! Minus!</p>
      </div>
      <div class="col-lg-4 p-4">
      ...
      <div class="col-lg-4 p-4">
        ...
        ?>
        <a href="<?php echo $contact_r['fb'] ?>" class="d-inline-block text-white text-decoration-none mb-2 ">
  ...
  <h6 class="text-center bg-dark text-white p-3 m-0">Designed and Developed by Kshitiz Tyagi</h6>
