      ...
      <div class="swiper-wrapper">
        <?php 
          ...
          while($row = mysqli_fetch_assoc($res)){
            ...
            echo <<<data
            <div class="swiper-slide"> <img src="$path$row[image]" class="w-100 d-block" /></div>
            data;
         }
        ?>
      </div>
        ...
        <div class="col-lg-4 col-md-6 my-3">
          <div class="card border-0 shadow" style="max-width: 350px; margin: auto;">
            ...
            <div class="card-body">
              ...
              <div class="d-flex justify-content-lg-evenly mb-2">
    ...
    <div class="swiper swiper-testimonials">
      <div class="swiper-wrapper mb-5">
        <div class="swiper-slide bg-white p-4">
          ...
          <p>
            Lorem ipsum, dolor sit amet consectetur adipisicing elit. Alias deserunt magnam hic totam aliquam, enim ea
            impedit rerum corporis reprehenderit.
          </p>
          <div class="rating">
            <i class="bi bi-star-fill text-warning"></i>
            <i class="bi bi-star-fill text-warning"></i>
      ...
      <form id="recovery-form">
        <div class="modal-header">
          <h5 class="modal-title d-flex align-items-center">
            <i class="bi bi-shield-lock fs-2 me-2"></i> Set up New Password
          </h5>
