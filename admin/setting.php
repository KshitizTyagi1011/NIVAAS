    ...
    <div class="container-fluid" id="main-content">
        <div class="row">
            <div class="col-lg-10 ms-auto p-4 overflow-hidden">
                ...
                <!-- SHUTDOWN SECTION -->
                <div class="card-body border-0 shadow-sm mb-4">
                    <div class="d-flex align-items-center justify-content-between mb-3">
                    ...
                    <p class="card-text">
                        No Customers will be allwed to book hotel room, when shutdown is turned on.
                    </p>
                </div>
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <button type="submit"
                                            class="btn custom-bg shadow-none text-white">SUBMIT</button>
                                    </div>
                                </div>
                        </form>
                    </div>
